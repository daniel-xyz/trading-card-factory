...
contract Cards {
	Card[] public cards;
	Card genesisCard = Card('Friendly Dragon', 12, 30, address(0), 0xfe0d246ece96ef9c6c317f4b76c7dd9be4be585c2f8f743d47d9de07a2e207c8, 200000000000000000);
	Card secondCard = Card('Unhappy Dragon', 43, 9, address(0), 0xfe0d246ece96ef9c6c317f4b76c7dd9be4be585c2f8f743d47d9de07a2e207c8, 150000000000000000);
	...
	function createCard(bytes32 _title, uint8 _attack, uint8 _defense, bytes32 _artwork, uint256 _weiPrice) public {
		cards.push(Card(_title, _attack, _defense, msg.sender, _artwork, _weiPrice));
